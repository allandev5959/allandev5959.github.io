...
If this is your first time using AWS, you need to sign up for an account on [aws.amazon.com](https://aws.amazon.com/){:target="_blank"}. You will be logged in as an AWS root user however it’s the best practice to create a separate IAM account for day-to-day usage. 
